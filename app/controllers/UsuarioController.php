...
class UsuarioController extends TWin8 {
    ...
    public function listar() {
        ...
        $usuarios = $this->logic->listar(null, 'nome', true);
        $this->addDados("listUsuarios", $usuarios);
    ...
    public function informar() {
        ...
        $this->addDados('perfilLogado', $this->SECURITY->getUsuario()->getPerfil()->getId());
        $this->addDados("objUsuario", $this->logic->obterPorId($this->getParam('id'),true));
    ...
    public function cadastrar() {
        ...
        $responsabilidade = implode(',', $this->SECURITY->getUsuario()->getPerfil()->getResponsabilidade());
    ...
    public function inserir() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $usuario->setDataCriacao(time());
            $usuario->setIdUsuarioCriador($this->SECURITY->getUsuario()->getId());
            $usuario->setStatus("A");

            # SALVAR USUARIO
            $salvar = $this->logic->salvar($usuario, true);
    ...
    public function editar() {
        ...
        # Adicionar dados a view
        $this->addDados("listPerfil", TFormHelper::optionSelect((!$perfis) ? null : $perfis));
        $this->addDados('json_objeto', $this->logic->objectToJson($objUsuario));

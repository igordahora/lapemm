/**
 * Verifica se email já existe na base de dados de usuario
 */
function ajaxCheckEmailUniqueUsuario (value){
    var result = "";

    $.ajax({
        type: "POST",
        url: 'index.php?Ajax/emailUniqueUsuario',
        async: false,
        data: {
            email:value
        },
 ...
 * Verifica se email já existe na base de dados de usuario
 */
function ajaxCheckEmailUniqueUsuarioEditar (value){
    var result = "";
    var id = $('#id').val();
    $.ajax({
        type: "POST",
        url: 'index.php?Ajax/emailUniqueUsuarioEditar',
        async: false,
        data: {
            email:value,
            idUsurio:id
...
(function($) {
    $.validator.addMethod("emailUniqueUsuario", function(value) {
        var result = ajaxCheckEmailUniqueUsuario(value);
        return eval(result);
    },"O email já estar sendo utilizado.");

    $.validator.addMethod("emailUniqueUsuarioEditar", function(value) {
        var result = ajaxCheckEmailUniqueUsuarioEditar(value);
        return eval(result);
    },"O email já estar sendo utilizado.");
